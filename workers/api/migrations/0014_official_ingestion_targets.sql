...
-- Use an application-owned table name so this Worker does not depend on the
-- incompatible source_ingestion_targets schema created by another migration
-- lineage in the shared staging D1 database.
