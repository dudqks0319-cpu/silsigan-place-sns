...
- the default per-IP daily ceiling is 20 uploads and 20 MiB because every final upload is capped at 1 MiB; upload ticket/write traffic is also limited to 5 requests per minute at the Cloudflare binding
